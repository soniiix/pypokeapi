...
def test_init_pokemon():
    ...
    assert pokemon.image[0].url == "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/384.png"
...
def test_from_name():
    ...
    assert pokemon.image[0].name == "front_default"
    assert pokemon.image[0].url == "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/132.png"
...
def test_get_moves():
    ...
    assert pokemon.get("moves")[0].get("move").get("url") == "https://pokeapi.co/api/v2/move/144/"
